...
<div class="create_user_responsive">
    ...
    <div class="create_user_absolute_form">
        <form action="#" method="POST" enctype="multipart/form-data" onsubmit="return false">
            ...
            <p class="input_text">Password <span class="asterix_obligatory">*</span><span class="format_password">Authorized chars: [a-z][A-Z][0-9]. At least one capital letter, a number and a minimum size of 5 letters</span></p><input class="create_user_password create_user_inputs" type="password" name="password" value=""/><br>
